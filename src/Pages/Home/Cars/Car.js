            ...
            <div className="container px-5 py-24 mx-auto">
                <div className="lg:w-4/5 mx-auto flex flex-wrap">
                    ...
                    <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                        <h2 className="text-2xl title-font text-gray-100 tracking-widest my-5">{brandName}</h2>
                        <h1 className="text-gray-300 text-3xl title-font font-medium mb-1">{model}</h1>
                        <div className="flex mb-4">
                            <span className="flex items-center">
                                ...
                                <span className="text-gray-600 ml-3">{seller.sellerRating} Reviews</span>
                            </span>
                        ...
                        <div className="flex">
                            <span className="title-font font-medium text-2xl text-gray-900">${resellPrice}</span>
